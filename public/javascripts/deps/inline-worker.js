// helper function for recorder.js
// should have been installed as a library, but copied from the library manually

var WORKER_ENABLED = !!(window && window.URL && window.Blob && window.Worker);

export default function InlineWorker(func, self) {
  var _this = this;
  var functionBody;
